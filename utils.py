...
def starting():
    for iii in range(0,101,10):
        sys.stdout.write(Fore.GREEN + f'\rroot@terminal:~$ loading | {iii}%' + Fore.RESET)
        time.sleep(0.1)
        sys.stdout.write(Fore.GREEN + f'\rroot@terminal:~$ loading / {iii}%' + Fore.RESET)
        time.sleep(0.1)
        sys.stdout.write(Fore.GREEN + f'\rroot@terminal:~$ loading - {iii}%' + Fore.RESET)
        ...
        time.sleep(0.1)
        if iii == 100:
            sys.stdout.write(Fore.GREEN + f'\rroot@terminal:~$ loading {iii}%   \n')
...
def main():
    ...
    query = input(Fore.GREEN + "root@terminal:~$ Please enter the query string you want to search (or enter '!quit' to exit): " + Fore.RESET)
    if query == "!quit":
        done = 'true'
        return query
